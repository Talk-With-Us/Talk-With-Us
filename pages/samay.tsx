...
export default function Home() {
  ...
  const handleFileUpload = async () => {
    ...
    const result = await fetch("/api/splitandembed?name=samay", {
      method: "POST",
    });
          ...
          <div className="chat-window">
            ...
            <div className="my-2 space-y-2">
              <div className="flex w-full space-x-2">
                ...
                />
                <Button
                  className={`border-gray-90 cursor-pointer rounded-lg border-2 border-solid border-sky-500 bg-orange-500 px-4 py-2 text-white shadow-lg shadow-cyan-500/50 ${
